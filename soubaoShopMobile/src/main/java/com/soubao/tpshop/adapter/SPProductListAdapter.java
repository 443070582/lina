...
public class SPProductListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.view1 = convertView.findViewById(R.id.product_cell_layout1);
            ...
            holder.view2 = convertView.findViewById(R.id.product_cell_layout2);
            ...
            holder.bottonLineView = convertView.findViewById(R.id.product_bottom_line_view);
        ...
        //获取该行数据
        SPProduct product1 = mProductLst.get(position * 2);
        ...
        holder.view1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mListener != null) {
                    mListener.onItemClickListener(mProductLst.get(position * 2));
                }
            }
        });
        ...
        if ((position * 2 + 1) < mProductLst.size()) {
            ...
            SPProduct product2 = mProductLst.get(position * 2 + 1);
            ...
            holder.view2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        mListener.onItemClickListener(mProductLst.get(position * 2 + 1));
                    }
                }
            });
        }
    ...
    public interface ItemClickListener {
        void onItemClickListener(SPProduct product);
    }
